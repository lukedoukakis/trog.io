...
public class Testing : MonoBehaviour
{
    ...
    void AddItemsToFaction(){
        ...
        Faction.AddItemOwned(faction, Item.ClothingTest, 2, null, playerHandle.transform);
        ...
        Faction.AddItemOwned(faction, Item.WoodPiece, 100, null, playerHandle.transform);
        Faction.AddItemOwned(faction, Item.BonePiece2, 100, null, playerHandle.transform);
